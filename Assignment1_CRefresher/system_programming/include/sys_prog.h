...
//
// NOTE THE FILE I/O MUST USE OPEN, READ, WRITE, CLOSE, LSEEK, STAT with file descriptors (NO FILE*)
...
// \param offset the starting location in the file, how many bytes inside the file to start reading from
...
// \param offset the starting location in the file, how many bytes inside the file to start writing from
