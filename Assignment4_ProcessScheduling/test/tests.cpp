...
TEST (round_robin, zeroQuantum) {
    ScheduleResult_t *sr = new ScheduleResult_t;
    dyn_array_t* pcbs = dyn_array_create(0,sizeof(ProcessControlBlock_t),NULL);
    bool res = round_robin (pcbs,sr,0);
    ASSERT_EQ(false,res);
    dyn_array_destroy(pcbs);
    delete sr;
...
//added
TEST (round_robin, includePriority) {
    ScheduleResult_t *sr = new ScheduleResult_t;
    dyn_array_t* pcbs = dyn_array_create(0,sizeof(ProcessControlBlock_t),NULL);
    memset(sr,0,sizeof(ScheduleResult_t));
...
//added
TEST (round_robin, processAlreadyStarted) {
    ScheduleResult_t *sr = new ScheduleResult_t;
    dyn_array_t* pcbs = dyn_array_create(0,sizeof(ProcessControlBlock_t),NULL);
    memset(sr,0,sizeof(ScheduleResult_t));
...
//added
TEST (first_come_first_serve, zeroTime) {
    ScheduleResult_t *sr = new ScheduleResult_t;
    dyn_array_t* pcbs = dyn_array_create(0,sizeof(ProcessControlBlock_t),NULL);
    memset(sr,0,sizeof(ScheduleResult_t));
...
/*  FCFS actually doesn't neet to take starting value into account, since it's not preemptive
//added
TEST (first_come_first_serve, processAlreadyStarted) {
    ScheduleResult_t *sr = new ScheduleResult_t;
    dyn_array_t* pcbs = dyn_array_create(0,sizeof(ProcessControlBlock_t),NULL);
    memset(sr,0,sizeof(ScheduleResult_t));
...
//added
TEST (first_come_first_serve, includePriority) {
    ScheduleResult_t *sr = new ScheduleResult_t;
    dyn_array_t* pcbs = dyn_array_create(0,sizeof(ProcessControlBlock_t),NULL);
    memset(sr,0,sizeof(ScheduleResult_t));
...
//added
TEST (load_process_control_blocks, returnInFileName) {

    dyn_array_t* da = load_process_control_blocks ("Error\n");
    ASSERT_EQ(da,(dyn_array_t*)NULL);
...
TEST (load_process_control_blocks, emptyFileName) {
    ...
    dyn_array_t* da = load_process_control_blocks ("");
    ASSERT_EQ(da,(dyn_array_t*)NULL);
